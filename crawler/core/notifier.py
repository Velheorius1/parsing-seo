...
# на одном и том же тексте — два прогона старого промпта в один день дали
# «Когоз» 30 и 85, «Ок когоз» 20 и 85, «Бумага для офисной техники цветная»
# 20 и 85; прод 24.09 отправил пушами Kseroks 360 млн и Maxsus 199,5 млн.
# Замер правила (flash-0731, живые строки базы): все офисные лоты, которые
# прод пропускал, — 0–25, включая плотную «А4 160 г / А3 200 г»; 13 бумажных
# лотов вне набора — 13/13 отказ (старый промпт пропустил «Бумага А4» с 85);
# бланки, формуляры, книги учёта, «варақаси», конверты, пакеты, наклейки —
# держатся; 40 случайных принятых лотов — 31 против 30/31 у старого промпта.
# Цена: снабженческий перечень «перфофайл + конверт + скотч» ушёл с 75 на 30.
