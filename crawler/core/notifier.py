...
- Монтаж вывесок, букв, наружная реклама (установка)
- Оклейка авто, тонировка
- Видеосъёмка, фото, SMM, реклама в Google/Instagram
- IT-услуги, разработка сайтов, настройка рекламы
- Организация мероприятий, ивенты
- Стройматериалы (алюкобонд, лестницы, леса)
- Мебель, оборудование, станки
- Только дизайн без печати
- Реклама ЧУЖИХ услуг ("мы делаем...", "звоните нам...")
- Слишком мелкий заказ (1-2 штуки)
