...
class TestExtractWords:
    ...
    def test_spec_tokens_are_stripped_not_kept(self):
        ...
        # «шт» само по себе остаётся: правило режет число С единицей («5000шт»),
        # а не единицу отдельным словом. Записано как есть, а не как хотелось.
        words = _extract_significant_words("Этикетки 5000 шт")
        assert words == {"этикетки", "шт"}, words
