...
class Settings(BaseSettings):
    ...
    alert_keywords: str = ",".join([
        ...
        # Замер за 14 дней / 60 000 строк: +6 записей (0.4 в день), все по делу —
        # брендированные сумки, брендированная продукция, бумажные крышки для
        # стаканов с брендированием. Дальше их всё равно судит AI-гейт.
