        ...
        <header className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <a
                href="/competitors"
                className="p-2 rounded-lg bg-gray-800 border border-gray-700 text-gray-400 hover:text-amber-400 hover:border-gray-600 transition-colors"
                title="Конкуренты"
              >
